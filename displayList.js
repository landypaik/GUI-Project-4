 ...
 * assumes that every graphical object as 4 functions:
 * 
...
(function () {
    ...
    var DisplayList = (function () {
        ...
        /*
         * This function is used to setup the DisaplyList it must be called 
         ...
         * 
         * The DisplayList assumes that all graphical objects have a the 4 
                ...
                for (var i = dl.length-1; i >= 0; i--) {
                    if(dl[i].contains){
                        if(dl[i].contains(x,y)){
                            if(this.log)console.log("\t found object:"+dl[i]);
                            return dl[i];
                        }
                    }
                    else {
